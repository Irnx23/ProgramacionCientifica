...
int main(int argc, char* argv[]) {
    ...
    if(mode=="-g"){
       ...
       // I->print();
        ...
        A->isFeasible(I); //Se coloca I solo para usar el tamaño de la instancia
        A->saveAsignacion(I,""); //Guarda el resultado del problema en un archivo de texto llamado 'Prueba.txt', se utiliza la instancia solo para leer el tamaño de esta.
        A->saveDatos(I,"");
        //A->~Solucion();
    }
}
